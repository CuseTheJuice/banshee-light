...
public class Sparrow implements WalletImport, WalletExport {
    ...
    public String getWalletExportDescription() {
        return "Exports this Banshee Light wallet file, which can be imported into another Banshee Light instance. If the wallet is encrypted, the same password is used to encrypt the exported file.";
    }
    ...
    public String getWalletImportDescription() {
        return "Imports an exported Banshee Light wallet file.";
    }
